...
# 概要 #
  ...
  * 東京電力と東北電力の計画停電予定表PDFをテキストで取得する。
  * PDFのテキスト化は、 GNU Xpdf http://www.foolabs.com/xpdf/ を使う。

# Xpdf 資料 #

  * [xpdf ホーム](http://www.foolabs.com/xpdf/)
  * [README](http://www.foolabs.com/xpdf/README)
  * [ダウンロード](http://www.foolabs.com/xpdf/download.html)

# 必要なもの #

  * 上記、ダウンロード先から、次のものをダウンロード。
  * [xpdf-3.02pl5-win32.zip](ftp://ftp.foolabs.com/pub/xpdf/xpdf-3.02pl5-win32.zip)
    * これを展開したもののうち、 pdftotext.exe だけを、 C:\tmp\xpdf にコピー。
  * [xpdf-japanese.tar.gz](ftp://ftp.foolabs.com/pub/xpdf/xpdf-japanese.tar.gz)
...
# シナリオ #
  ...
  * [シナリオとスクリプトの閲覧](http://code.google.com/p/cowares-wpost/source/browse/trunk/teiden_tepco_jp/)
  * pdf ファイル名のルールがわからないので、とりあえず手で書き換えて流す方式。
    * ピンポイントで取りたいので、メインページから解析するのは却下。
    * 東北電力のは、発表時刻をファイル名にしてるから予測不可能だ。
  * 東京電力の地域別明細は読めない。（セキュリティで蹴られるょ）
